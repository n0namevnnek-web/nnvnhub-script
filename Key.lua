...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/n0namevnnek-web/nnvnhub-script/refs/heads/main/NNVN%20Hub", -- The raw URL of your main script
    ...
    HubDescription  = "Animal Hospital Script" -- The text shown below the title
}
